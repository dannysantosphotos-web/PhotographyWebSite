        ...
        <div className="grid lg:grid-cols-5 gap-12">
          ...
          <form onSubmit={handleCheckout} className="lg:col-span-2 space-y-4">
            ...
            <button
              ...
              className="w-full mt-4 py-4 gradient-teal text-primary-foreground text-body text-sm font-semibold uppercase tracking-widest rounded-full hover:opacity-90 transition-all disabled:opacity-40 disabled:cursor-not-allowed inline-flex items-center justify-center gap-3"
            >
